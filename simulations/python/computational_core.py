...
class ClinicalStressTestEngine:
    ...
    def pde_system_stochastic(self, t, y, p):
        ...
        for i in range(1, N-1):
            ...
            D_ibu_eff  = p["D_ibu"] * hydration_factor
            D_egcg_eff = p["D_egcg"] * hydration_factor
        ...
        return np.concatenate([dC_ibu, dC_egcg, dC_syn, dH_gel, dC_cort, dB_cort])
    ...
    def run_stress_trial(self, trial_id, time_days=15):
        ...
        y_init = np.concatenate([C_ibu_0, C_egcg_0, C_syn_0, H_gel_0, C_cort_0, B_cort_0])
