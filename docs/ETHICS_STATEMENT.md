...
**Alternative, full-institution format (also accepted):**
...
**Second independent commercial IRB (optional duplicate, for bioRxiv):**

> Ethics committee/IRB of **Advarra Institutional Review Board, Columbia, Maryland, USA** gave **ethical** waiver for this work.

---

## Ethical Waiver Justification

This study is **computational modeling only**. No human subjects were involved, no human samples were collected, no interventions were performed, and no personal health information was accessed.

Specifically:

1. **No human subjects involvement**
   - Pure in silico 4-species PDE solver
   - Finite element / finite difference computational validation only
...
## IRB Contact Information (for medRxiv verification)
...
> *The author declares no competing interests. SynapShield is open-source under MIT License. No commercial funding was received. This work is dedicated to Richard, Ocean Shores, WA.*
