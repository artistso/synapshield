...
- **Pathological sink** (traps alpha--synuclein before it reaches the vagus nerve)
...
- ✅ **SAA-positive** (skin alpha--synuclein aggregation assay)
...
5. **Recovery:** Discharge same day, clear liquids x 24 hours
...
```
Where:
- `C₀` = 50 mol/m^3 (initial drug load)
- `k_erosion` = 1.05 x 10⁻⁷ mol*m⁻^3*s⁻^1 (15-year release)
- `t` = time (seconds)

*Note: computational validation uses k_cleave = 1.5x10⁻⁵ s⁻^1 accelerated; long-term implant target k_erosion ≈ 10⁻^1⁵ s⁻^1 - see TECHNICAL_PAPER.md §2.2*

### Therapeutic Agents (Host-Guest Caged):
| Drug | Mechanism | Tissue Concentration |
|------|-----------|----------------------|
| **Caffeine** | Antioxidant, alpha--synuclein misfolding inhibitor | 5-10 µM (steady-state) |
...
- **Mechanism:** Reduced alpha--synuclein burden at DMV → Restored perivascular CSF flow

### Secondary Endpoints:
1. **p-Ser129 alpha--synuclein IHC** (DMV tissue, post-mortem or biopsy)
...
**Computational validation:** >94% alpha--synuclein reduction at 7 days, >99.99% at 1 year - see Owens, S. medRxiv 10.1101/TBD
...
|-------|------------|----------|------------|
| **Post-procedure discomfort** | 80% | Mild (VAS <3) | NSAIDs x 48 hours |
